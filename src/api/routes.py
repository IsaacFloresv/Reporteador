...
def user_creation():
        ...
        user = User(email=email,name=name,lastname=lastname,lawyer_id=lawyer_id,password=password,)
...
def clients_creation():
        ...
        clients = Clients(email=email,name=name,lawyer_id=lawyer_id,is_active=is_active,first_lastname=first_lastname,second_lastname=second_lastname)
