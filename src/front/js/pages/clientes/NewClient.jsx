    ...
    return (
        <div>
            <div className="d-flex justify-content-between my-3">
                <div>
                    <label className="p-0">Add new client</label>
                </div>
                <div>
                    ...
                    <div>
                        <div className="row">
                            <div className="col-md-6">
                                <label>Names</label>
                                <input type="text" className="form-control" aria-label="Proceeding"/>
                            </div>
                            <div className="col-md-6">
                            ...
                            <div className="col-md-6">
                                <label>
                                    Email #2<text className="text-black-50">
                                        (optional)</text>
                                </label>
                                <input type="text" className="form-control" aria-label="Proceeding"/>
                                <text className="float-end text-primary">
                            ...
                            <div className="col-md-6">
                                <label>
                                    Adress #2<text className="text-black-50">
                                        (optional)</text>
                                </label>
                                <input type="text" className="form-control" aria-label="Proceeding"/>
                                <text className="float-end text-primary">
                        ...
                        <div className="d-flex ">
                            ...
                            <label className="text-dark fw-light">
                                O
                            </label>
                            <button className="btn btn-link text-dark fw-bold">
                                Create a new case
