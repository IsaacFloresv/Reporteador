          ...
          >
            <div className="container">
              <div className="w-75 mx-auto">
                ...
                <div className="row">
                  <div class="col-md-6">
                    <label for="validationCustom01" class="form-label m-0">
                      Full Name
                    </label>
                    <input
                      type="text"
                ...
                <div class="col-md-12">
                  <label for="validationCustom03" class="form-label m-0">
                    Email
                  </label>
                  <input
                    type="text"
                ...
                <div class="col-md-12">
                  <label for="validationCustom02" class="form-label m-0">
                    Paswword
                  </label>
                  <input
                    type="text"
                ...
                <div class="col-md-12">
                  <label for="validationCustom05" class="form-label m-0">
                    Verify password
                  </label>
                  <input
                    type="text"
