        ...
        <div className="container-fluid fw-bold">
            <div className="row">
                <div className="col-xl-5 p-0 d-none d-lg-block vh-100">
                    <img className="img-responsive" style={{objectFit:"cover"}}
                        src={login_image}/>
                </div>
                <form class="col-12 col-xl-7  d-flex align-items-center needs-validation  " novalidate>
                    ...
                    <div className="col-6 text-center mx-auto ">
                        <img classname="text-center" style={{width:100+"%"}} src={logo}/>
                    </div>
                    ...
                    <div>
                        <button className="btn btn-primary ">Olvide mi contraseña</button>
                    </div>
                    </div>
                    <div class="col-12">
